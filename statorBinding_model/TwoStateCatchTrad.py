...
class TwoStateCatchTrad():
    ...
    def make_trace(self,
                   ...
                   Ns0=0, Nw0=0, 
                   njumps=30, 
                   plots=0, plots_all=False, clear_plot=True, color='k'):
        ''' Kinetic Montecarlo 
        ...
        for t in range(njumps-1):
            ...
            Rws = kws*Nw[t]
            Rwu = kwu*Nw[t]
            Rus = kus*(self.Nmax-Ns[t]-Nw[t])
            Ruw = kuw*(self.Nmax-Ns[t]-Nw[t])
        ...
        if plots or plots_all: 
            plt.figure('make_trace', clear=clear_plot)     
            if plots_all:
